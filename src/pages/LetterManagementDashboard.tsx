...
import { Sparkles, FilePenLine, PenTool, FileSignature, ArrowRight, LayoutGrid, List } from "lucide-react";
...
const letterScreens: LetterScreenProps[] = [
    { id: 1, title: "Generate Letter", path: "/letter/generate", icon: Sparkles },
    { id: 2, title: "Letter Editor", path: "/letter/editor", icon: FilePenLine },
    { id: 3, title: "Add Signature", path: "/signature/add", icon: PenTool },
    { id: 4, title: "Signature List", path: "/signature/list", icon: FileSignature, },
];

export default function LetterManagementDashboard() {
